...
var jsonMetadataList = (function(){
  return fs.readdirSync('/library/www/html/home/metadata').filter(function(each) {
...
function createMetadata(jsonObject) {
  ...
  fs.writeFileSync('/library/www/html/home/metadata/' + obj.moddir + '.json', JSON.stringify(obj));
}
